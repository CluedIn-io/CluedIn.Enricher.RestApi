...
To use the `Google Maps` External Search with the `CluedIn` server you will have to add the CluedIn.Enricher.GenericRest nuget package to your environment.
